        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HijriDate = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    HijriMonth = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IslamicEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrayerTimeValue = table.Column<TimeSpan>(type: "time", nullable: false),
                    DisplayNameEn = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DisplayNameBn = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Category = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PrayerType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SslResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MiladDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiladRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MiladRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MiladRequests_Status",
                table: "MiladRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_MiladRequests_UserId",
                table: "MiladRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PrayerTimes_DisplayOrder",
                table: "PrayerTimes",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_PrayerTimes_PrayerName",
                table: "PrayerTimes",
                column: "PrayerName",
                unique: true);
