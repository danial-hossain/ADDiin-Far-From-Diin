...
{
    /*
    FEATURE BRANCH VERSION — KEPT FOR REFERENCE ONLY.
    ...
    public class HadithService : IHadithService
    {
        ...
        public async Task<IReadOnlyList<Hadith>> GetDailyHadithsAsync(
            CancellationToken cancellationToken = default)
        {
            ...
            var dailyHadiths = await FetchDailyHadithsAsync(
                date,
                slotIndex,
                cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                var hadithNumber = GetHadithNumber(
            ...
            var replacementNumber = GetHadithNumber(
            ...
            {
                replacementNumber = GetHadithNumber(
            ...
            foreach (var hadithNumber in hadithNumbers)
            {
                ...
                {
                    var response =
                        await _httpClient.GetFromJsonAsync<HadithApiResponse>(
    ...
    */
    ...
    public interface IHadithService
    {
        Task<ScheduledHadith?> GetCurrentHadithAsync(
            CancellationToken cancellationToken = default);

        Task EnsureCurrentHadithAsync(
            CancellationToken cancellationToken = default);
    }
